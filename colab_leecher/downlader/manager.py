...
async def downloadManager(source, is_ytdl: bool):
    message = "<blockquote>\n<b>Please Wait...</b> \n<i>Merging YTDL Video...</i> </blockquote>"
        ...
        for i, link in enumerate(source):
            try:
                if is_google_drive(link):
                    ...
                    aria2_dn = f"<blockquote><b>PLEASE WAIT </b>\n\n__Getting Download Info For__\n\n<code>{link}</code></blockquote>"
                    try:
                        await MSG.status_msg.edit_text(
        ...
        if is_google_drive(link):
            ...
            try:
                ...
                if "File not found" in str(e):
                    err = "<blockquote>The file link you gave either doesn't exist or You don't have access to it!</blockquote>"
